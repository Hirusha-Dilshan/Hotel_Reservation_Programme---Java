...
public class CircularQueue<E> implements Serializable {
 ...
 private int rear;//rear position of Circular queue(new element enqueued 
at rear).
 ...
 */
 ...
 if (isFull()) {
 throw new QueueFullException("Circular Queue is full. Element 
cannot be added");
 }
 else {
 ...
 */
 ...
 E deQueuedElement;
 if (isEmpty()) {
 throw new QueueEmptyException("Circular Queue is empty. Element 
cannot be retrieved");
 }
 else {
